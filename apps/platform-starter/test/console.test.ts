...
describe("renderConsoleHtml", () => {
  it("returns a complete HTML document with the console root and API wiring", () => {
    ...
    expect(html).toContain("/patch-artifact")
    expect(html).toContain("View patch artifact")
    expect(html).toContain("查看补丁产物")
    ...
    expect(html).toContain("attachment-thumb")
    expect(html).toContain("renderAttachments")
    expect(html).toContain("Source context")
